 ...
 * route. fromSteamId comes from the verified session (context.data.authedSteamId,
 * set by _middleware.js) — never trust a client-supplied "this is me" field.
 */
